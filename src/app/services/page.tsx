...
export default function Services() {
  ...
  const services = [
    {
      ...
      icon: <Code2 className="w-6 h-6 sm:w-8 sm:h-8 text-teal-500" />,
      color: "bg-teal-50",
    ...
    },
    {
      ...
      icon: <MonitorSmartphone className="w-6 h-6 sm:w-8 sm:h-8 text-yellow-500" />,
      color: "bg-yellow-50",
    ...
    },
    {
      ...
      icon: <LayoutTemplate className="w-6 h-6 sm:w-8 sm:h-8 text-pink-500" />,
      color: "bg-pink-50",
    ...
    },
    {
      ...
      icon: <Settings className="w-6 h-6 sm:w-8 sm:h-8 text-slate-700" />,
      color: "bg-slate-100",
  ...
  return (
    <div className="w-full flex flex-col items-center bg-white pb-16 sm:pb-24 overflow-hidden">
      
      {/* ULTRA-PREMIUM SERVICES HERO */}
      {/* Using strictly pt-16 for all screen sizes as requested */}
      <section className="relative w-full max-w-7xl mx-auto px-6 pt-16 pb-16 sm:pb-24 md:pb-32 text-center">
        ...
        >
          <div className="inline-flex items-center gap-2 px-3 py-1.5 sm:px-4 sm:py-2 rounded-full bg-slate-50 border border-slate-200 shadow-sm mb-4 sm:mb-6">
            ...
            <span className="text-[10px] sm:text-xs font-bold uppercase tracking-wider text-slate-700">Our Capabilities</span>
          </div>

          <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-black text-slate-900 mb-4 sm:mb-8 tracking-tight leading-[1.1]">
            Specialized Digital <br className="hidden sm:block" />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-500 via-yellow-500 to-pink-500">
              Engineering.
            </span>
          </h1>
          
          <p className="max-w-2xl mx-auto text-base sm:text-lg md:text-xl text-slate-600 font-medium leading-relaxed">
              ...
              >
                ...
                <div className="w-full lg:w-1/2">
                  <div className="relative w-full aspect-[4/3] rounded-[1.5rem] overflow-hidden shadow-2xl border border-slate-100 group">
                    <div className="absolute inset-0 bg-slate-100 flex flex-col items-center justify-center text-slate-400 group-hover:scale-105 transition-transform duration-700 p-4 sm:p-6 text-center">
                      <p className="font-bold text-base sm:text-lg md:text-xl">{service.imagePlaceholder}</p>
                      <p className="text-[10px] sm:text-xs md:text-sm mt-2">(Save image as /public/{service.imageName})</p>
                    </div>
                ...
                <div className="w-full lg:w-1/2 flex flex-col justify-center">
                  ...
                  <div className="flex flex-wrap gap-2 md:gap-3 mb-8 sm:mb-10">
                    {service.tags.map((tag, i) => (
                      <span key={i} className="px-3 py-1.5 md:px-4 md:py-2 rounded-full bg-slate-50 border border-slate-200 text-[10px] sm:text-xs md:text-sm font-bold text-slate-700 flex items-center gap-1.5 sm:gap-2">
                        <CheckCircle2 size={14} className="text-teal-500 shrink-0 sm:w-4 sm:h-4" />
                        {tag}
                      </span>
                    ))}
                  </div>
                  ...
                  <a 
                    ...
                    className="inline-flex items-center self-start gap-2 sm:gap-3 bg-white border-2 border-[#25D366] text-[#25D366] hover:bg-[#25D366] hover:text-white px-5 py-2.5 sm:px-6 sm:py-3 rounded-full font-bold text-sm sm:text-base transition-all duration-300 group shadow-sm hover:shadow-md"
                  >
      ...
      {/* BOTTOM CTA SECTION */}
      <section className="w-full max-w-7xl mx-auto px-6 mt-20 sm:mt-32">
        <div className="bg-slate-900 rounded-[2rem] p-6 sm:p-10 md:p-20 text-center relative overflow-hidden">
          ...
          >
            <h2 className="text-2xl sm:text-4xl md:text-5xl font-black text-white mb-4 sm:mb-6">Need a custom solution?</h2>
            <p className="text-slate-400 text-sm sm:text-base md:text-lg mb-8 sm:mb-10 max-w-2xl mx-auto">
              Our engineering team is ready to architect and deploy your digital platform to the highest industry standards.
            </p>
            <Link 
              href="/contact" 
              className="inline-flex w-full sm:w-auto justify-center items-center gap-2 bg-teal-500 hover:bg-teal-400 text-slate-900 px-6 py-3.5 sm:px-8 sm:py-4 md:px-10 md:py-5 rounded-full font-black text-sm sm:text-base md:text-lg transition-all duration-300 shadow-[0_0_30px_rgba(20,184,166,0.3)] hover:-translate-y-1"
            >
              Get a Proposal
